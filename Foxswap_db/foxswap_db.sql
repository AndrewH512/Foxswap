-- FoxSwap SQL Script to create tables and insert testing data for the database

-- Create and use the foxswap database
create database if not exists foxswap_db;
USE foxswap_db;

-- Drop all tables if it exists
...
CREATE TABLE Transaction (
    ...
    Price VARCHAR(20) NOT NULL,                               -- Foreign key referencing the price of the post
...
-- Next will be insert either test data or Admin informtion into each table to test
